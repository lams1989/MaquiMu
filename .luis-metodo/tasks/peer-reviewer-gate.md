...
**SIEMPRE** verificar el `.luis-metodo/core-config.yaml` para el `qa.qaLocation/gates`
...
1. **SIEMPRE** crear archivo gate en: `qa.qaLocation/gates` desde `.luis-metodo/core-config.yaml`
...
### Revisado Por: Revisor par - luis (Arquitecto de Pruebas)
