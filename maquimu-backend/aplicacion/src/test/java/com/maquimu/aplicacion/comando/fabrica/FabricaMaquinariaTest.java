...
class FabricaMaquinariaTest {
	...
	void crear_conComandoValido_deberiaCrearMaquinariaConEstadoDisponible() {
		ComandoCrearMaquinaria comando = new ComandoCrearMaquinaria("Excavadora", "Caterpillar", "320D", "EXC-001",
	...
	void actualizar_conComandoValido_deberiaActualizarCamposCorrectamente() {
		Maquinaria maquinariaExistente = new Maquinaria(1L, "Excavadora", "Caterpillar", "320D", "EXC-001",
				EstadoMaquinaria.DISPONIBLE, BigDecimal.valueOf(1000), BigDecimal.valueOf(150), "Excavadora de orugas");

		ComandoActualizarMaquinaria comando = new ComandoActualizarMaquinaria(1L, "Excavadora Mod", "Cat", "320DL",
				"EXC-001-MOD", "ALQUILADO", BigDecimal.valueOf(1200), BigDecimal.valueOf(180),
				"Excavadora de orugas modificada");
	...
	void actualizar_conComandoParcial_deberiaActualizarSoloCamposProporcionados() {
		...
		ComandoActualizarMaquinaria comando = new ComandoActualizarMaquinaria(1L, null, null, null, null,
				"EN_MANTENIMIENTO", BigDecimal.valueOf(1100), null, "Mantenimiento requerido");
