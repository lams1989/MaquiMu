package com.maquimu.infraestructura.alquiler.controlador;
...
public class ConsultaControladorAlquiler {
	...
	public ConsultaControladorAlquiler(ManejadorMaquinariasDisponibles manejadorMaquinariasDisponibles,
			ManejadorAlquileresCliente manejadorAlquileresCliente, AlquilerDao alquilerDao, ClienteDao clienteDao,
			ServicioGeneradorJwt servicioGeneradorJwt) {
	...
	/**
	 * Lista maquinarias disponibles en un rango de fechas. GET
	 * /api/maquimu/v1/maquinarias/disponibles?fechaInicio=2024-01-01T00:00:00&fechaFin=2024-01-10T23:59:59
	 */
	...
	/**
	 * Lista los alquileres de un cliente específico. GET
	 * /api/maquimu/v1/clientes/{clienteId}/alquileres
	 */
	...
	/**
	 * Lista todos los alquileres, opcionalmente filtrados por estado. GET
	 * /api/maquimu/v1/alquileres GET /api/maquimu/v1/alquileres?estado=PENDIENTE
	 */
	...
	/**
	 * Obtiene el detalle de un alquiler por ID. GET /api/maquimu/v1/alquileres/{id}
	 */
	...
	/**
	 * Obtiene el detalle de un alquiler verificando que pertenece al cliente
	 * autenticado. GET /api/maquimu/v1/alquileres/mis-alquileres/{id}
	 */
	...
	private Long extraerUsuarioIdDesdeJwt(HttpServletRequest request) {
		...
		return servicioGeneradorJwt.obtenerUsuarioIdDelToken(token);
	}
}
