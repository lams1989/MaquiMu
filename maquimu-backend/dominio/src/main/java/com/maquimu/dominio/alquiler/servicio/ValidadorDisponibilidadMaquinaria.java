...
/**
 * Servicio de dominio para validar disponibilidad de maquinaria.
...
public class ValidadorDisponibilidadMaquinaria {
    ...
    public boolean estaDisponible(Long maquinariaId, LocalDateTime fechaInicio, LocalDateTime fechaFin, Long excluirAlquilerId) {
        ...
        List<Alquiler> alquileresEnRango = alquilerDao.buscarPorMaquinariaYRangoFechas(
                maquinariaId, fechaInicio, fechaFin);
