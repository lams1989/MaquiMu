...
class ManejadorCrearMaquinariaTest {
	...
	void ejecutar_serialExistente_deberiaLanzarExcepcion() {
		...
		assertEquals(String.format("La maquinaria con serial %s ya existe.", comando.getSerial()),
	...
	void ejecutar_serialNoExistente_deberiaCrearMaquinariaCorrectamente() {
		ComandoCrearMaquinaria comando = new ComandoCrearMaquinaria("Excavadora", "Caterpillar", "320D", "EXC-001",
				BigDecimal.valueOf(1000), BigDecimal.valueOf(150), "Excavadora de orugas");
		Maquinaria nuevaMaquinaria = new Maquinaria("Excavadora", "Caterpillar", "320D", "EXC-001",
