package com.maquimu.infraestructura.utilidades.documento.adaptador;
...
public class OpenPdfGeneradorFactura implements GeneradorFacturaPort {
	...
	private void agregarSeccionAlquiler(Document document, Alquiler alquiler, Maquinaria maquinaria)
		...
		// Datos
		String nombreMaquinaria = maquinaria.getNombreEquipo() + " - " + maquinaria.getMarca() + " "
	...
	private void agregarEstadoPago(Document document, Factura factura) throws DocumentException {
		...
		case PAGADO:
			colorEstado = new Color(25, 135, 84);
			break; // green
		case ANULADO:
			colorEstado = new Color(220, 53, 69);
			break; // red
		default:
			colorEstado = new Color(255, 193, 7);
	...
	private void agregarPieDePagina(Document document) throws DocumentException {
		...
		Paragraph footer2 = new Paragraph(
				"Este documento no requiere firma y es válido como comprobante de facturación.", FONT_FOOTER);
