...
class AuthControllerTest {
    ...
    void register_registroExitoso_deberia200() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(post("/api/maquimu/v1/auth/register")
    ...
    void login_credencialesValidas_deberia200ConToken() throws Exception {
        ...
        RespuestaAutenticacion respuesta = RespuestaAutenticacion.builder()
        ...
        // Act & Assert
        mockMvc.perform(post("/api/maquimu/v1/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
