...
/**
 * Manejador del comando para registrar la entrega de maquinaria.
 * Transición compleja transaccional:
 * - Alquiler: APROBADO -> ACTIVO
 * - Maquinaria: DISPONIBLE -> ALQUILADO
 */
@Service
public class ManejadorEntregarAlquiler {
    ...
    public ManejadorEntregarAlquiler(AlquilerDao alquilerDao,
