...
class ManejadorGenerarFacturaTest {
    ...
    void ejecutar_clienteSinTelefonoODireccion_deberiaLanzarExcepcion() {
        ...
        ComandoGenerarFactura comando = ComandoGenerarFactura.builder()
        ...
        assertEquals("Para generar factura el cliente debe tener teléfono y dirección registrados", exception.getMessage());
    ...
    void ejecutar_clienteConDatosCompletos_deberiaGenerarFactura() {
        ...
        Factura facturaGuardada = new Factura(1L, alquilerId, clienteId, LocalDateTime.now().toLocalDate(), new BigDecimal("900000"), com.maquimu.dominio.factura.modelo.EstadoPago.PENDIENTE);
