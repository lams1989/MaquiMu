...
public class Maquinaria {
	...
	public Maquinaria(Long maquinariaId, String nombreEquipo, String marca, String modelo, String serial,
			EstadoMaquinaria estado, BigDecimal tarifaPorDia, BigDecimal tarifaPorHora, String descripcion) {
		this.maquinariaId = maquinariaId;
		this.nombreEquipo = Optional.ofNullable(nombreEquipo)
				.orElseThrow(() -> new IllegalArgumentException("El nombre del equipo no puede ser nulo."));
		this.marca = Optional.ofNullable(marca)
				.orElseThrow(() -> new IllegalArgumentException("La marca no puede ser nula."));
		this.modelo = Optional.ofNullable(modelo)
				.orElseThrow(() -> new IllegalArgumentException("El modelo no puede ser nulo."));
		this.serial = Optional.ofNullable(serial)
				.orElseThrow(() -> new IllegalArgumentException("El serial no puede ser nulo."));
		this.estado = Optional.ofNullable(estado).orElse(EstadoMaquinaria.DISPONIBLE); // Estado inicial por defecto
		this.tarifaPorDia = Optional.ofNullable(tarifaPorDia)
				.orElseThrow(() -> new IllegalArgumentException("La tarifa por día no puede ser nula."));
		this.tarifaPorHora = Optional.ofNullable(tarifaPorHora)
				.orElseThrow(() -> new IllegalArgumentException("La tarifa por hora no puede ser nula."));
	...
	public Maquinaria(String nombreEquipo, String marca, String modelo, String serial, EstadoMaquinaria estado,
			BigDecimal tarifaPorDia, BigDecimal tarifaPorHora, String descripcion) {
	...
	public Maquinaria(Long maquinariaId, String nombreEquipo, String marca, String modelo, String serial,
			BigDecimal tarifaPorDia, BigDecimal tarifaPorHora, String descripcion) {
		this(maquinariaId, nombreEquipo, marca, modelo, serial, EstadoMaquinaria.DISPONIBLE, tarifaPorDia,
				tarifaPorHora, descripcion);
	}
