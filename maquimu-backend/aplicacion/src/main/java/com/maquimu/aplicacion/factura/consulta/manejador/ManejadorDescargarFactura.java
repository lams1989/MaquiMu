...
/**
 * Manejador de consulta para descargar el PDF de una factura.
 * Recopila todos los datos necesarios y delega al puerto generador de PDF.
 */
@Service
public class ManejadorDescargarFactura {
    ...
    public ManejadorDescargarFactura(FacturaDao facturaDao,
                                      AlquilerDao alquilerDao,
                                      ClienteDao clienteDao,
                                      MaquinariaDao maquinariaDao,
                                      GeneradorFacturaPort generadorFacturaPort) {
    ...
    public byte[] ejecutar(Long facturaId) {
        ...
        Alquiler alquiler = alquilerDao.buscarPorId(factura.getAlquilerId())
                .orElseThrow(() -> new IllegalArgumentException("Alquiler no encontrado con ID: " + factura.getAlquilerId()));

        Cliente cliente = clienteDao.buscarPorId(factura.getClienteId())
