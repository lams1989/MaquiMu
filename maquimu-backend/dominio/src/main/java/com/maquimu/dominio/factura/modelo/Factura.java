...
/**
 * Entidad de dominio que representa una factura generada para un alquiler finalizado.
...
public class Factura {
     ...
     */
    public Factura(Long facturaId, Long alquilerId, Long clienteId,
                   LocalDate fechaEmision, BigDecimal monto, EstadoPago estadoPago) {
