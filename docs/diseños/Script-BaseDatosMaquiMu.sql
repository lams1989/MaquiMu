...
DROP DATABASE IF EXISTS `maquimu_db`;
CREATE DATABASE `maquimu_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `maquimu_db`;

-- 2. Tabla: usuarios
[cite_start]-- Almacena las cuentas de los empleados [cite: 751]
-- -----------------------------------------------------
...
-- 3. Tabla: clientes
[cite_start]-- Contiene la información de las empresas que alquilan [cite: 752]
-- -----------------------------------------------------
...
-- 4. Tabla: maquinaria
[cite_start]-- Inventario central de equipos [cite: 753]
-- -----------------------------------------------------
...
-- 5. Tabla: alquileres
[cite_start]-- Tabla transaccional que registra los contratos [cite: 759]
-- -----------------------------------------------------
...
-- 6. Tabla: facturas
[cite_start]-- Almacena la información financiera de cada alquiler [cite: 760]
-- -----------------------------------------------------
