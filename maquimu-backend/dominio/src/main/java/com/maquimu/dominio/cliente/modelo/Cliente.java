...
public class Cliente {
	...
	public Cliente(Long clienteId, Long usuarioId, String nombreCliente, String identificacion, String telefono,
	...
	public Cliente(Long clienteId, Long usuarioId, String nombreCliente, String apellido, String identificacion,
			String telefono, String email, String direccion, LocalDateTime fechaRegistro) {
		this.clienteId = clienteId;
		// usuarioId ahora puede ser nulo cuando se registra un cliente sin usuario
		// asociado
		this.usuarioId = usuarioId;
		this.nombreCliente = Optional.ofNullable(nombreCliente).filter(n -> !n.isBlank())
				.orElseThrow(() -> new IllegalArgumentException("El nombre del cliente no puede ser nulo o vacío."));
		this.apellido = Optional.ofNullable(apellido).map(String::trim).filter(a -> !a.isBlank()).orElse(null);
		this.identificacion = Optional.ofNullable(identificacion).filter(i -> !i.isBlank())
				.orElseThrow(() -> new IllegalArgumentException("La identificación no puede ser nula o vacía."));
		this.email = Optional.ofNullable(email).filter(e -> !e.isBlank())
	...
	public Cliente(Long usuarioId, String nombreCliente, String identificacion, String telefono, String email,
			String direccion) {
	...
	public Cliente(Long usuarioId, String nombreCliente, String apellido, String identificacion, String telefono,
