...
required:
  ...
  - story_path: `.luis-metodo/core-config.yaml` para el `devStoryLocation`

optional:
  - architecture_refs: `.luis-metodo/core-config.yaml` para el `architecture.architectureFile`
  - technical_preferences: `.luis-metodo/core-config.yaml` para el `technicalPreferences`
