...
/**
 * Puerto de lectura para Alquiler (DAO - Data Access Object). Define
 * operaciones de consulta sin modificar datos.
 */
public interface AlquilerDao {
	 ...
	 */
	List<Alquiler> buscarPorMaquinariaYRangoFechas(Long maquinariaId, LocalDateTime fechaInicio,
