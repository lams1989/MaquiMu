...
/**
 * Manejador del comando para finalizar un alquiler activo. Transición compleja
 * transaccional: - Alquiler: ACTIVO -> FINALIZADO - Maquinaria: ALQUILADO ->
 * DISPONIBLE
 */
@Service
public class ManejadorFinalizarAlquiler {
	...
	public ManejadorFinalizarAlquiler(AlquilerDao alquilerDao, AlquilerRepositorio alquilerRepositorio,
