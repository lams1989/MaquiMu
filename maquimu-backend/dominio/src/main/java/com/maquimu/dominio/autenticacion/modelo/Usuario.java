...
public class Usuario {
	...
	public void aprobar() {
		if (this.estado != EstadoUsuario.PENDIENTE_APROBACION) {
			throw new IllegalStateException(
					"Solo se pueden aprobar usuarios en estado PENDIENTE_APROBACION. Estado actual: " + this.estado);
		}
	...
	public void rechazar(String motivo) {
		if (this.estado != EstadoUsuario.PENDIENTE_APROBACION) {
			throw new IllegalStateException(
					"Solo se pueden rechazar usuarios en estado PENDIENTE_APROBACION. Estado actual: " + this.estado);
		}
	...
	public void solicitarRestablecimiento() {
		if (this.estado != EstadoUsuario.ACTIVO) {
			throw new IllegalStateException(
					"Solo se puede solicitar restablecimiento de contraseña en estado ACTIVO. Estado actual: "
							+ this.estado);
		}
	...
	public void resolverRestablecimiento(String nuevoPasswordHash) {
		if (this.estado != EstadoUsuario.RESTABLECER) {
			throw new IllegalStateException(
					"Solo se puede resolver restablecimiento en estado RESTABLECER. Estado actual: " + this.estado);
		}
