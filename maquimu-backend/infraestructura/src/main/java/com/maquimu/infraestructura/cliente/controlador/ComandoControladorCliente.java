package com.maquimu.infraestructura.cliente.controlador;
...
public class ComandoControladorCliente {
	...
	public ComandoControladorCliente(ManejadorCrearCliente manejadorCrearCliente,
			ManejadorActualizarCliente manejadorActualizarCliente, ManejadorEliminarCliente manejadorEliminarCliente,
	...
	public ResponseEntity<Map<String, Long>> crearCliente(@RequestBody ComandoCrearCliente comandoCrearCliente,
		...
		ComandoCrearCliente comando = ComandoCrearCliente.builder().usuarioId(usuarioId)
				.nombreCliente(comandoCrearCliente.getNombreCliente()).apellido(comandoCrearCliente.getApellido())
				.identificacion(comandoCrearCliente.getIdentificacion()).telefono(comandoCrearCliente.getTelefono())
				.email(comandoCrearCliente.getEmail()).direccion(comandoCrearCliente.getDireccion()).build();
	...
	public ResponseEntity<Void> actualizarCliente(@PathVariable("id") Long id,
		...
		ComandoActualizarCliente comando = ComandoActualizarCliente.builder().clienteId(id)
				...
				.telefono(comandoActualizarCliente.getTelefono()).email(comandoActualizarCliente.getEmail())
				.direccion(comandoActualizarCliente.getDireccion()).build();
