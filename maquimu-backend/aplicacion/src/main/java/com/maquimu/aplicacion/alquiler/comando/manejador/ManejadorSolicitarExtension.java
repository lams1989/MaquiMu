 ...
 * Valida disponibilidad y calcula costo adicional.
 */
@Service
public class ManejadorSolicitarExtension {
    ...
    public ManejadorSolicitarExtension(AlquilerDao alquilerDao,
    ...
    public Alquiler ejecutar(ComandoSolicitarExtension comando) {
        ...
        // 3. Validar disponibilidad en el rango extendido (excluyendo el propio alquiler)
        boolean disponible = validadorDisponibilidad.estaDisponible(
                alquiler.getMaquinariaId(),
                alquiler.getFechaFin(), // desde la fecha fin actual
        ...
        BigDecimal costoAdicional = calculadorCosto.calcularCostoPorDias(
                maquinaria,
