...
public class ManejadorActualizarEstadoPago {
    ...
    public ManejadorActualizarEstadoPago(FacturaDao facturaDao,
    ...
    public Factura ejecutar(ComandoActualizarEstadoPago comando) {
        // 1. Buscar la factura
        Factura factura = facturaDao.buscarPorId(comando.getFacturaId())
                .orElseThrow(() -> new IllegalArgumentException(
                        "Factura no encontrada con ID: " + comando.getFacturaId()));
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Estado de pago no válido: " + comando.getEstadoPago() +
        ...
        switch (nuevoEstado) {
            ...
            default:
                throw new IllegalArgumentException(
                        "No se puede cambiar al estado: " + nuevoEstado);
        }
