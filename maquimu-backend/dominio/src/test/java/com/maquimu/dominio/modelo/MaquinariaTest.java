...
class MaquinariaTest {
	...
	void crearMaquinaria_conValoresValidos_deberiaCrearseCorrectamente() {
		Maquinaria maquinaria = new Maquinaria("Excavadora", "Caterpillar", "320D", "EXC-001",
	...
	void crearMaquinaria_conTarifaPorDiaCero_deberiaLanzarExcepcion() {
		Exception exception = assertThrows(IllegalArgumentException.class, () -> {
			new Maquinaria("Excavadora", "Caterpillar", "320D", "EXC-001", EstadoMaquinaria.DISPONIBLE, BigDecimal.ZERO,
					BigDecimal.valueOf(150), "Excavadora de orugas");
		});
	...
	void alquilarMaquinaria_estadoNoDisponible_deberiaLanzarExcepcion() {
		Maquinaria maquinaria = new Maquinaria(1L, "Excavadora", "Caterpillar", "320D", "EXC-001",
				EstadoMaquinaria.ALQUILADO, BigDecimal.valueOf(1000), BigDecimal.valueOf(150), "Excavadora de orugas");
	...
	void devolverMaquinaria_estadoEnMantenimiento_deberiaCambiarADisponible() {
		Maquinaria maquinaria = new Maquinaria(1L, "Excavadora", "Caterpillar", "320D", "EXC-001",
				EstadoMaquinaria.EN_MANTENIMIENTO, BigDecimal.valueOf(1000), BigDecimal.valueOf(150),
